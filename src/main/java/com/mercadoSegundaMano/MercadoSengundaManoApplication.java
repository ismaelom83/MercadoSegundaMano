package com.mercadoSegundaMano;
...
import com.mercadoSegundaMano.servicio.ProductoServicio;
import com.mercadoSegundaMano.servicio.UsuarioServicio;
import com.mercadoSegundaMano.upload.StorageService;


@SpringBootApplication
public class MercadoSengundaManoApplication {

	public static void main(String[] args) {
		SpringApplication.run(MercadoSengundaManoApplication.class, args);
	}
